...
//static const fp32 fliter_num[3] = {1.0f, 0.0f, 0.0f};
...
/**
  ...
  * @retval         none
  */
float INS_YawAngleLast;
float INS_YawRoundCount;
float INS_YawTotalAngle;
...
//            ist8310_read_mag(ist8310_real_data.mag);
				...
				if (INS_angle[0] - INS_YawAngleLast > 3.1415926f)
				{
						INS_YawRoundCount--;
				}
				else if (INS_angle[0] - INS_YawAngleLast < -3.1415926f)
				{
						INS_YawRoundCount++;
				}
				INS_YawTotalAngle = 6.283f* INS_YawRoundCount + INS_angle[0];
				INS_YawAngleLast = INS_angle[0];
